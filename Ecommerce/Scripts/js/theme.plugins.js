	...
	$(document).ready(function(){
		...
		------------------------------------------------ */
			...
			if ($('#slider').length) {
			    ...
			    window.startRangeValues = [parseFloat($('#minval').val()), parseFloat($('#maxval').val())];
			    //window.startRangeValues = [28.00, 562.00];
			    //console.log(window.startRangeValues);
			    $('#slider').slider({
			        range: true,
			        min: 1,
			        max: 10000,
			        ...
			        slide: function (event, ui) {
			            ...
			            range.children('.min_val').text('NRs ' + min).next().text('NRs ' + max);
