...
namespace Common.GlobalData
{
    public static class ReadConfigData
    {
        ...
        {
            string username = "";
            string conString = System.Configuration.ConfigurationManager.ConnectionStrings["GrihastiContext"].ConnectionString;
        ...
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["GrihastiContext"].ConnectionString;           
        }
