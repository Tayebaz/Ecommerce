...
namespace Ecommerce.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    if (string.IsNullOrEmpty(model.ReturnUrl))
                    {
                        ...
                        return RedirectToAction("Index", "AdminOrderDetails", new { area = "Admin" });
                    }
                    else
                    {
                        Server.ClearError();
        ...
        [AllowAnonymous]
        [Route("ConfirmEmail")]
        public ActionResult ConfirmEmail(string tkn)
        {
            var user = _userBusiness.GetListWT(x => x.TokenKey == tkn && x.IsConfirmed == false).FirstOrDefault();
            if (user == null)
            {
